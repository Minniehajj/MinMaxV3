...
const Hero: FC<HeroProps> = ({
  ...
  return (
    ...
    >
      ...
      />
      <div className="prose top-1/2 right-20 mt-8 rounded border bg-opacity-80 p-2 dark:prose-invert lg:absolute lg:mt-0 lg:bg-theme-white lg:p-8 lg:dark:bg-theme-black">
        <h1>{title}</h1>
        <p>{description}</p>
